...
export const CampHubModal: React.FC<CampHubModalProps> = ({ player, onClose, onEnchantAdded }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-fade-in">
      <div className="relative w-full max-w-3xl rounded-xl border-2 border-amber-600/70 bg-gradient-to-b from-stone-900 to-stone-950 p-6 shadow-2xl text-stone-100 flex flex-col gap-5 max-h-[90vh] overflow-y-auto">
        {/* Header */}
